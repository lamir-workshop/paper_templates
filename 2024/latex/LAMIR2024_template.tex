...
% ------
\title{Paper Template for LAMIR \conferenceyear ~Workshop}
...
%$^3$  Company, Address\\
%{\tt\small CorrespondenceAuthor@lamir.edu, PossibleOtherAuthor@lamir.edu}
%}
...
This template includes all the information about formatting manuscripts for the
LAMIR \conferenceyear\ Workshop. This template is based on the ISMIR
\conferenceyear ~Conference paper template.
...
This template can be downloaded from the LAMIR \conferenceyear\ GitHub
repository (\texttt{http://github.com/lamir\-workshop/paper\_templates/\conferenceyear}).
%
\section{Paper Length \& File Size}
We adopt a ``(4+N)-page policy'' for LAMIR \conferenceyear. That is, each paper
may have a maximum of four pages of technical content (including figures and tables) \textcolor{red}{with additional optional pages that contain only references and acknowledgments. Note that acknowledgments should not be included in the anonymized submission.}
